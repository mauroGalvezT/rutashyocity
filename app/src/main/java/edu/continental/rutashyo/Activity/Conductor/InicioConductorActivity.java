                ...
                @Override public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                    switch (item.getItemId()) {
                        ...
                        case R.id.itemProfile:
                            ...
                            dialogPersonalizado = new Dialog(InicioConductorActivity.this);
                                        ...
                                        call.enqueue(new Callback<RespuestaPerfil>() {
                                            ...
                                            public void onResponse(Call<RespuestaPerfil> call, Response<RespuestaPerfil> response) {
                                                if(response.isSuccessful()){
                                                    ...
                                                    Toast.makeText(InicioConductorActivity.this, "Inicio sus datos de acceso", Toast.LENGTH_SHORT).show();
                                            ...
                                            public void onFailure(Call<RespuestaPerfil> call, Throwable t) {
                                                Toast.makeText(InicioConductorActivity.this, "problemas de conexion", Toast.LENGTH_SHORT).show();
